  ...
  return (
    <div className="pointer-events-none absolute inset-0 z-20 flex items-center justify-center">
      ...
      >
        ...
        />
        <div className="absolute inset-[8%] rounded-full border border-white/10 bg-[radial-gradient(circle,rgba(255,255,255,0.08),rgba(15,23,42,0.96)_72%)]" />
        ...
        <div
          className={[
            ...
            isSpinning ? 'drop-shadow-[0_0_28px_rgba(249,115,22,0.5)]' : '',
          ].join(' ')}
          style={{
        ...
        >
          ...
          <div className="absolute left-1/2 top-[18%] h-[58%] w-[28%] -translate-x-1/2 rounded-full bg-gradient-to-b from-aurora via-neon to-bubblegum shadow-[0_16px_30px_-18px_rgba(236,72,153,0.85)]" />

function QuestionCard({
  ...
  return (
    <div className="rounded-[1.8rem] border border-white/10 bg-gradient-to-br from-white/10 via-white/5 to-white/[0.03] p-5 shadow-party sm:p-6">
      <div className="flex flex-wrap items-center gap-3">
        <span className="flex h-12 w-12 items-center justify-center rounded-[1.15rem] bg-white/10 text-2xl">
          {selectedPlayerAvatar || '🙂'}
        </span>
      ...
      <p className="mt-5 font-display text-[1.7rem] font-semibold leading-8 text-white sm:text-2xl sm:leading-9">
        {prompt}
      </p>
      {roundResult ? (

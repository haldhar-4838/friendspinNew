function Button({
  ...
  const variants = {
    primary:
      'border border-white/10 bg-[linear-gradient(135deg,rgba(236,72,153,0.95),rgba(139,92,246,0.95),rgba(16,185,129,0.92))] text-white shadow-[0_24px_50px_-22px_rgba(139,92,246,0.75)] hover:brightness-110',
    secondary:
